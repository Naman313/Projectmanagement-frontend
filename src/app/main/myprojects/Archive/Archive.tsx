...
import ArchiveComponent from '@/components/myProjects/ArchiveComponent';
import { Search, ChevronRight } from 'lucide-react';
export default function Archive() {
  const [query, setQuery] = useState<string>("")
  return (
    <>
      <div className="min-h-screen bg-[#F8F7FA] pl-2">
        <div className="pb-6 pt-3 px-6 font-sans">
          ...
          <nav className="flex items-center space-x-[0.5px] mb-6 text-[#808080] text-[13.5px]">
            ...
            <span className="text-[#808080]"><ChevronRight width={20} height={20} strokeWidth={1.5} /></span>
            <span className="text-[#4D4D4D] font-medium text-[14px]">Archive</span> {/*No link for current page*/}
          </nav>
