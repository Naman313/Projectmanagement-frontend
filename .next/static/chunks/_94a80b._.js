(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_94a80b._.js", {
...
const AddTeamMembers = ({ onClose, onAddMember, teamMembers })=>{
    ...
    const [selectedMembers, setSelectedMembers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(teamMembers);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AddTeamMembers.useEffect": ()=>{
            const searchUsers = {
                "AddTeamMembers.useEffect.searchUsers": async ()=>{
                    if (!searchTerm.trim()) {
                        setSearchResults([]);
                        return;
                    }
                    try {
                        ...
                        const filteredResults = response.data.filter({
                            "AddTeamMembers.useEffect.searchUsers.filteredResults": (member)=>!selectedMembers.some({
                                    "AddTeamMembers.useEffect.searchUsers.filteredResults": (selected)=>selected._id === member._id
                                }["AddTeamMembers.useEffect.searchUsers.filteredResults"])
                        }["AddTeamMembers.useEffect.searchUsers.filteredResults"]);
            ...
            }["AddTeamMembers.useEffect.searchUsers"];
            const timeoutId = setTimeout(searchUsers, 500);
            return ({
                "AddTeamMembers.useEffect": ()=>clearTimeout(timeoutId)
            })["AddTeamMembers.useEffect"];
        }
    }["AddTeamMembers.useEffect"], [
        searchTerm,
...
_s(AddTeamMembers, "ScY+fUQJ2sQpAJ/oBXAH4PDrLvs=");
_c = AddTeamMembers;
    ...
    const AddMilestoneFromOverview = async ()=>{
        ...
        try {
            ...
            if (response.status === 200) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Milestone added successfully");
                setTimeout(()=>{
                    onClose();
                }, 2000);
            }
...
//# sourceMappingURL=_94a80b._.js.map